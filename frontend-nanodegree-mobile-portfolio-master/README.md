...
### How to open a file
* unzip the folder
* then open the index.html file to execute it in browser
*pizza.html 
...
*Use internal Css and use async attribute in javascript.
=>use media="print" in print.css file when it is linked so that when we have to print only it should run at that time.
*Remove whitespaces
